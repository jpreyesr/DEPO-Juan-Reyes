...
public class Aerolinea
{
    ...
    public Vuelo getVuelo(String codigoRuta, String fechaVuelo) {
    	...
    	for (Vuelo cada_vuelo : vuelos ) {
    		String fecha = cada_vuelo.getFecha();
    		if (fecha.equals(fechaVuelo)) {
    			if (cada_vuelo.getRuta().getCodigoRuta().equals(codigoRuta)) {
    				respuesta = cada_vuelo;
    			}
    ...
    public void salvarAerolinea( String archivo, String tipoArchivo ) throws TipoInvalidoException, IOException
    {
        // TODO implementar
    	 ...
    	 for (Vuelo cada_vuelo : vuelos) {
    		 ...
    		 jRuta.put(cada_vuelo.getRuta().getHoraSalida(), cada_vuelo.getRuta().getHoraLLegada(), )
    		 
    		 
    		 
    		 jVuelo.put(cada_vuelo.getFecha(), jRuta, );
    	 }
    }
